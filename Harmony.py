...
def pedir_cosas():
    ...
    while comenzar:
        ...
        if "uno" in pedido or "internet" in pedido:
        ...
        elif "dos" in pedido or "aplicación" in pedido:
        ...
        elif "noticia" in pedido or "tres" in pedido:
            webbrowser.open("https://www.diariolibre.com")

        elif "cuatro" in pedido or "fecha" in pedido:
            pedir_dia()
            continue

        elif "cinco" in pedido or "hora" in pedido:
            pedir_hora()
            continue

        elif "seis" in pedido or "wikipedia" in pedido:
        ...
        elif "ocho" in pedido or "chiste" in pedido:
            hablar(pyjokes.get_joke("es"))
            continue

        elif "nueve" in pedido or "mensaje" in pedido:
        ...
        elif "diez" in pedido or "salir" in pedido:
